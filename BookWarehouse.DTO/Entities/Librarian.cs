...
namespace BookWarehouse.DTO.Entities
{
    public class Librarian : DomainEntity<int>, IDateTracking
    {
        ...
        [Required(ErrorMessage = "Librarian name is required !")]
        [StringLength(100, MinimumLength = 6, ErrorMessage = "Librarian name must be at least 6 characters and no more than 100 characters.")]
